...
def test_command_with_bool_flags(result: TestResult) -> bool:
    ...
    if not (check_flag_value("testCmd02", "verbose", False) and 
            check_flag_value("testCmd02", "debug", False)):
...
def test_all_templates(result: TestResult) -> bool:
    ...
    if template_tests_passed == template_tests_total:
        ...
        result.add_result("All templates test", False, f"Failed {template_tests_total - template_tests_passed} template tests")
        return False
